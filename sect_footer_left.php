...
<?if($TEMPLATE_FOOTER_VARIANT == "3" || $TEMPLATE_FOOTER_VARIANT == "4" || $TEMPLATE_FOOTER_VARIANT == "8"):?>
	<div class="logo">
		<?if(MAIN_PAGE === TRUE):?>
			<a href="<?=SITE_DIR?>"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/logoW.png" alt=""></span></a>
		<?else:?>
...
<?elseif($TEMPLATE_FOOTER_VARIANT == "5" || $TEMPLATE_FOOTER_VARIANT == "6" || $TEMPLATE_FOOTER_VARIANT == "7"):?>
	<div class="logo">
		<?if(MAIN_PAGE === TRUE):?>
			<a href="<?=SITE_DIR?>"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/logoB.png" alt=""></span></a>
		<?else:?>
...
<?else:?>
	<div class="logo">
		<?if(MAIN_PAGE === TRUE):?>
			<a href="<?=SITE_DIR?>"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/logo.jpeg" alt=""></span></a>
		<?else:?>
			<a href="<?=SITE_DIR?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/logo.jpeg" alt=""></a>
		<?endif;?>
	</div>
