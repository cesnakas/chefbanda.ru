...
$APPLICATION->SetPageProperty("title", "Официальный сайт бренда поварской одежды Bandit");
$APPLICATION->SetPageProperty("description", "Поварская форма Bandit в интернет-магазине Chef Banda");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SORT_VALUE" => "ASC",
		"COMPONENT_TEMPLATE" => ".default",
		"CATALOG_ITEM_TEMPLATE" => "template1",
...
<div class="elfsight-app-93e1fce1-c2c9-48cb-9c56-cd3056849548"></div>
