...
$APPLICATION->SetPageProperty("title", "Новости компании Chef Banda, интернет-магазин поварской одежды");
$APPLICATION->SetPageProperty("description", "Читайте наши новости, чтобы всегда быть в курсе последний событий интернет-магазина поварской одежды Chef Banda.");
$APPLICATION->SetTitle("");?><h1>Наши новости</h1>
